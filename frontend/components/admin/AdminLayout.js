...
export default function AdminLayout({ children, title, subtitle }) {
  ...
  const navigation = [
    ...
    { name: 'Expenses', href: '/admin/expenses', icon: Wallet, permission: 'expenses', section: 'System' },
    { name: 'Revenue', href: '/admin/revenue', icon: IndianRupee, permission: 'revenue', section: 'System' },
