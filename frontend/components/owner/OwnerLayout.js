        ...
        <div className={`flex items-center border-b border-gray-100 px-4 py-4 ${isCollapsed ? 'justify-center' : 'justify-between'}`}>
          {!isCollapsed && (
            <div>
              ...
              <p className="text-[10px] text-gray-400 font-semibold uppercase tracking-wider mt-0.5">Owner Portal</p>
            </div>
          )}
        ...
        <header className="bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-3 sticky top-0 z-20">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:flex flex-col text-right leading-tight">
              <span className="text-sm font-bold text-gray-800 max-w-[180px] truncate">{user?.name || 'Owner'}</span>
              <span className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">Owner Partner</span>
            </div>
